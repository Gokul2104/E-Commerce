...
<div class="site-branding-area">
    <div class="container">
        <div class="row">
            <div class="col-sm-6">
                <div class="logo">
                    <h1><a href="<?php echo base_url() ?>index.php/Welcome"><span>Shri Ganapathy Stores</span></a></h1>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="navbar-collapse collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li><a href="<?php echo base_url() ?>index.php/Welcome/shop">Grocery</a></li>
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <?php
                            if(isset($_SESSION['email'])){
                                if(!$_SESSION['email'] == ''){
                                    ?>
                                   <li><a class = "pull-right" style="position: absolute;" href="<?php echo base_url() ?>index.php/Cart/viewCart"> <i class="fa fa-shopping-cart"></i></a></li>
                                    <?php
