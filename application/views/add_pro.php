...
<head>
    ...
    <title>Shri Ganapathy Stores Template</title>
...
<div class="container">
    <div class="well">
        ...
        <div class="form-group">
			...
			<select class="form-group" name="pro_cat" id="pwd">
        <option value="householdcare">Household Care</option>
        <option value="snacksbeverage">Snacks & Beverage</option>
		<option value="packagedfood">Packaged Food</option>
		<option value="personalbabycare">Personal & Baby Care</option>
		...
		<div class="form-group">
            ...
            <input type="text" name="offer" class="form-control" id="pwd">
        </div>
